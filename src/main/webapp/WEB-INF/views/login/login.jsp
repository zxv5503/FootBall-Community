...
if (cookies != null) {
	...
	System.out.println(rememberedId);
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
		<form id="loginForm" action="loginInsert" method="post">
			...
			<div class="form-floating">
				<input type="email" class="form-control" id="floatingInputEmail"
					name="email" accept-charset="UTF-8" placeholder="이메일"> <label
					for="floatingInput">e-mail</label>
			</div>
			<div class="form-floating">
				<input type="password" class="form-control" id="floatingInputPw"
					name="password" accept-charset="UTF-8" placeholder="비밀번호"> <label
					for="floatingInput">password</label>
			</div>

			<div class="form-check text-start my-3">
				<input class="form-check-input" type="checkbox"
					id="flexCheckDefault" checked="checked" name="remember"> <label
		...
		<form action="/signUp" method="post">
			<button class="btn btn-info w-100 py-1" type="submit">Sign
				up</button>
		</form>
	...
	<script>
		...
		// 쿠키 저장 함수
		function saveId() {
			var rememberMeCheckbox = document
					.getElementById("flexCheckDefault");
			var idInput = document.getElementById("floatingInputId");
			...
			if (rememberMeCheckbox.checked) {
				...
				// 쿠키에 아이디 저장
				document.cookie = "rememberedId=" + idInput.value
