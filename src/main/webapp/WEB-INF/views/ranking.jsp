...
<body>
	...
	<div class="container">
		...
		<div class="nav-scroller py-1 mb-3 border-bottom">
			<nav class="nav nav-underline justify-content-center">
				...
				<a class="nav-item nav-link link-body-emphasis" href="/">팀 순위</a>
 ...
 <div class="container bg-body-secondary rounded">
    <h3 class="left my-2">개인 순위</h3>
    <div class="row">
        <div class="col-md-3"> <!-- 4개의 열로 테이블 배치 -->
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">${tb1}</th>
		...
		<div class="row g-5">
			<div class="col-md-8">
				<h3 class="pb-4 mb-4 fst-italic border-bottom">선수 기록</h3>
