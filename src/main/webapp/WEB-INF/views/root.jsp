...
<link rel="icon" href="favicon.ico" type="assets/brand/x-icon"/>
...
<div class="container">
        ...
        <div
            ...
            <div class="col-4 text-center">
                <a class="blog-header-logo text-body-emphasis text-decoration-none"
                   href="/" style="font-size: 1.5em;"><strong>FootBall
                    Community</strong></a>
            </div>
            <div class="col-4 d-flex justify-content-end align-items-center">
                <a class="link-secondary" href="#" aria-label="Search">
                    <svg
                        ...
                        href="/memberUpdateForm">Update </a> <a
                    class="btn btn-sm btn-outline-secondary" href="/login">Log in
            </a> <a class="btn btn-sm btn-outline-secondary" href="/logout">Log
                out </a>
            </div>
        </div>
    </header>
    ...
    <div class="nav-scroller py-1 mb-3 border-bottom">
        <nav class="nav nav-underline justify-content-center">
            ...
            <a class="nav-item nav-link link-body-emphasis" href="/">팀 순위</a> <a
                class="nav-item nav-link link-body-emphasis" href="/ranking">개인
            순위</a> <a class="nav-item nav-link link-body-emphasis" href="/news">뉴스</a>
            <a class="nav-item nav-link link-body-emphasis" href="/list">자유게시판</a>
...
<main class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <table class="table">
                    ...
                    <thead>
                    <tr>
                        <td td colspan="2" style="text-align: center;">${eplWhere}</td>

                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="text-align: center;">${left1}${left1Result}${mid1}${right1Result}${right1}</td>
                        <td style="text-align: center;"></td>
                    </tr>
                    <!-- 추가적인 일정 행을 필요한 만큼 추가하세요 -->
                    </tbody>
                </table>
            </div>
            <div class="col-md-4">
                <table class="table">
                    ...
                    <tr>
                        <th scope="col" style="text-align: center;">${date }</th>
                        <th scope="col" style="text-align: center;">챔스 경기</th>
                    </tr>
                    </thead>
                    <thead>
                    <tr>
                        <td colspan="2" style="text-align: center;">${clWhere}</td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="text-align: center;">${left2}${left2Result}${mid2}${right2Result}${right2}</td>
                        <td style="text-align: center;">${left3}${left3Result}${mid3}${right3Result}${right3}</td>
                    </tr>
                    <!-- 추가적인 일정 행을 필요한 만큼 추가하세요 -->
                    </tbody>
                </table>
    ...
    <div class="row g-5">
        <div class="col-md-8">
            <h3 class="pb-4 mb-4 fst-italic border-bottom">리그 순위</h3>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><img src="/assets/img/eplMark/${team.teamName}.png"
                                    ...
                                    href="select?teamName=${team.teamName}">${team.teamName}</a>
                            </td>
            ...
            <nav class="blog-pagination" aria-label="Pagination">
                <a class="btn btn-outline-primary rounded-pill" href="/updateForm">update</a>
                    ...
                    <ul class="list-unstyled">
                        <li><a
                            ...
                            <svg class="bd-placeholder-img" width="100%"
                                ...
                                <image href="/assets/img/news1.jpg" width="100%"
                                       height="100%"/>
                            </svg>
                            <div class="col-lg-8">
                        ...
                        <li><a
                            ...
                            <svg class="bd-placeholder-img" width="100%"
                                 ...
                                 aria-hidden="true" preserveAspectRatio="xMidYMid slice"
                                 focusable="false">
                                <image href="/assets/img/news2.jpg" width="100%"
                                       height="100%"/>
                            </svg>
                            <div class="col-lg-8">
                        ...
                        <li><a
                            ...
                            <svg class="bd-placeholder-img" width="100%"
                                 ...
                                 aria-hidden="true" preserveAspectRatio="xMidYMid slice"
                                 focusable="false">
                                <image href="/assets/img/mainoo37.png" width="100%"
                                       height="100%"/>
                            </svg>
                            <div class="col-lg-8">
