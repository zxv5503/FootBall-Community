		...
		<article class="blog-post">
			...
			<div class="row">
				<div class="col-md-8">
								...
								<c:forEach items="${epl}" var="team" varStatus="status">
									<tr>
										...
										<td><img src="/assets/img/eplMark/${team.teamName}.png"
											...
											href="serieUpdate?teamName=${team.teamName}">${team.teamName}</a></td>
										...
										<td>${team.goalsSum}</td>
										<td>${team.points}</td>
										<td><a href="serieDelete?teamName=${team.teamName}">삭제</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
					...
					<a class="btn btn-outline-primary rounded-pill" href="/serieInsertForm">insert</a>
